...
export const uploadApi = {
  ...
  getUploadedFiles: (page = 1, pageSize = 20): Promise<PaginatedResponse<UploadFile>> =>
    apiCall(() => api.get(`/upload?page=${page}&pageSize=${pageSize}`)),
