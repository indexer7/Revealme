...
import { Card, CardHeader, CardTitle, CardDescription, CardContent, Table, TableBody, TableCell, TableHead, TableHeader, TableRow, Button, Label, Slider, Switch } from '@/components/ui';
