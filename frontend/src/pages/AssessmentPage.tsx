...
import { Button, Card, CardHeader, CardTitle, CardDescription, Progress, Spinner, useToast } from '@/components/ui';
...
export default function AssessmentPage() {
  ...
  if (error) {
    ...
    return <div className="text-red-500">Failed to load scan data.</div>;
  }
